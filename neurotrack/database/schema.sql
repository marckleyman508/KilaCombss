...
CREATE TABLE users (
  ...
  role          VARCHAR(20)  NOT NULL CHECK (role IN ('admin', 'doctor', 'caregiver', 'patient')),
...
CREATE INDEX idx_user_patient_access_user_id ON user_patient_access(user_id);
CREATE INDEX idx_user_patient_access_patient_id ON user_patient_access(patient_id);
